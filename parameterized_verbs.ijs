...
NB.*defineAndDefaultParams c Prepends monadic verb definition with default parameter handling
...
parameterizedVerb_base_=: 3 : 0 NB. verb defn
...
znames=. 'ddp mpt defn'
locnames=. 'defineAndDefaultParams makeParamTable defn'
znames export2z locnames
